function shakeMagic8Ball() {
    const question = prompt('Enter a Decade and see what happened on my Birthday!!')
    if (question === null) {
    ...
    switch (randomNumber) {
        ...
        case 1:
            ...
            Image = "imgs/HurricaneMichaelLandfall.webp"
            color = "text-danger"
            break
        case 2:
